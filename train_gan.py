...
def main():
    ...
    parser.add_argument("--config_path",
                        type=str,
                        default="./configs/train/ESRGAN_x4-DIV2K.yaml",
    ...
    for epoch in range(start_epoch, config["TRAIN"]["HYP"]["EPOCHS"]):
        ...
        if is_best or is_last:
            save_checkpoint({
                ...
                "g_best.pth.tar" if is_best else "g_last.pth.tar",
                samples_dir,
                results_dir,
                "g_best.pth.tar",
                "g_last.pth.tar",
            ...
            save_checkpoint({
                ...
                "d_best.pth.tar" if is_best else "d_last.pth.tar",
                samples_dir,
                results_dir,
                "d_best.pth.tar",
                "d_last.pth.tar",
...
def train(
    ...
    while batch_data is not None:
        ...
        with amp.autocast():
            ...
            content_loss = content_criterion(sr, gt, sr_output, gt_output)
