...
from imgproc_imagenet import random_crop_torch, random_rotate_torch, random_vertically_flip_torch, random_horizontally_flip_torch, preprocess_imagenet
...
from messageUtil import send_email
import time
import ssl
...
def main():
    ...
    g_model, ema_g_model, d_model, vgg19_model, alexnet, resnet50, densenet161, wrn, squeezenet, mobilenet_v2 = build_model(
        config, device)
...
def build_model(
    ...
    # wrn= models.wide_resnet101_2(pretrained=True).to(device)
...
if __name__ == "__main__":
    ...
    # send_email("train_ESRGAN完成", title="ESRGAN训练完成")
